...
class PerceptronSimpleMnist(nn.Module):
    ...
    def __init__(self):
        ...
        self.hidden1 = nn.Linear(784, 128) #--> 784 *100 = 78400 W , 28x28 # 입력 784, 출력 128
        #self.drop_out1 = nn.Dropout(p=0.3)
        self.hidden2 = nn.Linear(128, 64)#128개의 출력을 입력으로 넣고 64개의 출력으로..
        #self.drop_out2 = nn.Dropout(p=0.3)
        self.hidden3 = nn.Linear(64, 10)#64개의 출력을 입력으로 넣고 10개의 출력으로..
